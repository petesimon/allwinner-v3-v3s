...
:: modified by petesimon with help from various users of www.goprawn.com forums
...
if %size% LSS %DESTSIZE% (
    ...
    "%~dp0sfk" "partcopy" "%~dp02-system.tmp" "0" "%DESTSIZE%" "%~dp0UNFEX\2-system.img" "-yes" "-quiet"
