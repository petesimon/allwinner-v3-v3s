...
"%~dp0sfk" "partcopy" "%~dp0blogo.tmp" "0" "131072" "%~dp0UNFEX\4-blogo.img" "-yes" "-quiet"
"%~dp0sfk" "partcopy" "%~dp0slogo.tmp" "0" "131072" "%~dp0UNFEX\5-slogo.img" "-yes" "-quiet"
...
:BADFILESIZE
echo File size of JPEG file(-s) exceeds 131072 bytes.
echo Press any key to exit...
pause>nul
exit
